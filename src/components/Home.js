...
const cities = [
  { city: "", code: "" },
  { city: "New York", code: "AX101" },
  { city: "SkyHigh Airlines", code: "SH202" },
  { city: "chicago", code: "chicago" },
  { city: "Kolkata", code: "CCU" },
  { city: "San Francisco	", code: "LKO" },
  { city: "Los Angeles", code: "ATQ" },
  { city: "Vishakhapatnam", code: "VTZ" },
  { city: "Kannur", code: "CNN" },
  { city: "Raipur", code: "RPR" },
  { city: "Surat", code: "STV" },
  { city: "miami", code: "miami" },
  { city: "Kochi", code: "COK" },
