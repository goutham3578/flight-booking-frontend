...
export const signUp = (data) => {
  return async (dispatch) => {
    try {
      ...
      const res = await axios.post("https://bms-backend-swart.vercel.app/flight/signup", user);
      console.log(res);
      dispatch({
        type: AUTH_SIGN_UP,
        payload: res.data,
...
export const signIn = (data) => {
  return async (dispatch) => {
    try {
      const res = await axios.post("https://bms-backend-swart.vercel.app/flight/signin", data);
      console.log(res);
      dispatch({
        type: AUTH_SIGN_IN,
        payload: {
          token: res.data.accesstoken, // Use the correct key
          user: { email: res.data.email,userType:res.data.userType,userId:res.data._id },
        }
      });
...
export const storeFlight = (flightId) => {
  ...
  return async (dispatch) => {
    try {
      const res = await axios.get("https://bms-backend-swart.vercel.app/flights/" + flightId);
  ...
  return async (dispatch) => {
    try {
      const res = await axios.delete(
        "https://bms-backend-swart.vercel.app/bookings/" + bookingId
      );
  ...
  return async (dispatch) => {
    try {
      const res = await axios.post(
        "https://bms-backend-swart.vercel.app/flights/search",
        data
      );
      console.log(res.data);
...
export const addUserDetails = (userId, formData) => {
  return async (dispatch) => {
    try {
      const res = await axios.post(
        "https://bms-backend-swart.vercel.app/users/" + userId,
        formData
      );
      console.log(res.data);
      // return res.data;
...
export const fetchUserDetails = (userId) => {
  ...
  return async (dispatch) => {
    try {
      const res = await axios.get("https://bms-backend-swart.vercel.app/users/" + userId);
      console.log(res.data);
  ...
  return async (dispatch) => {
    try {
      const res = await axios.get(
        "https://bms-backend-swart.vercel.app/bookings/userDetails/" + userDetailId
      );
      console.log(res.data);
      dispatch({
        type: GET_BOOKINGS,
...
export const bookFlight = (user, flight) => {
  return async (dispatch) => {
    try {
      ...
      const res = await axios.post("https://bms-backend-swart.vercel.app/bookings", {
        user,
        flight,
      });
      dispatch({
